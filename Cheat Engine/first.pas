...
initialization
  ...
  begin
    ...
    if r.OpenKey('\Software\'+{$ifdef altname}'Runtime Modifier'{$else}'NCEW'{$endif},false) then
    begin
    ...
    begin
      ...
      if r.OpenKey('\Software\'+{$ifdef altname}'Runtime Modifier'{$else}'NCEW'{$endif},true) then
      begin
        //I do have access
